...
public class ManagerControllerTest {
    ...
    public void testJoinTeacherWithUser() throws Exception {
        ...
        joinTeacherWithUserDTO.setTeacherId(13L);
        joinTeacherWithUserDTO.setUserId(16L);
        ...
        Teacher teacher = teacherService.getById(13L);
        User user = userService.getById(16L);
