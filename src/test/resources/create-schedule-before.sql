...
insert into de3rldngv565ak."public".semesters(id, current_semester, default_semester, description, end_day, start_day, "year", disable) VALUES
...
insert into de3rldngv565ak."public".lessons(id, hours, lessontype, subject_for_site, link_to_meeting, semester_id, group_id, subject_id, teacher_id) VALUES
(4, 1, 'LECTURE', '', '', 4, 4, 4, 4),
(5, 1, 'LABORATORY', '', '', 5, 5, 5, 5),
(6, 2, 'LABORATORY', '', '', 4, 4, 5, 6),
(7, 2, 'PRACTICAL', '', '', 6, 6, 6, 6);

insert into de3rldngv565ak."public".schedules(id, day_of_week, evenodd, lesson_id, period_id, room_id) VALUES
(4, 'MONDAY', 'EVEN', 4, 4, 4),
(5, 'MONDAY', 'ODD', 5, 5, 5),
(6, 'MONDAY', 'ODD', 4, 5, 6),
(7, 'MONDAY', 'ODD', 6, 6, 6);
