...
public class StudentServiceImpl implements StudentService {
    ...
    public Student getById(Long id) {
        log.info("Enter into getById method of StudentServiceImpl with id {}", id);
    ...
    public List<Student> getAll() {
        log.info("Enter into getAll method of StudentServiceImpl with no input params");
    ...
    public Student save(Student object) {
        log.info("Enter into save method of StudentServiceImpl with entity:{}", object);
    ...
    public Student update(Student object) {
        log.info("Enter into update method of StudentServiceImpl with entity:{}", object);
        if (Objects.isNull(object)) {
            throw new EntityNotFoundException(Student.class, "id", String.valueOf(object.getId()));
        }
    ...
    public Student delete(Student object) {
        log.info("Enter into delete method of StudentServiceImpl with entity:{}", object);
    ...
    public Student getByEmail(String email) {
        log.info("Enter into findByEmail method of StudentServiceImpl with email:{}", email);
    ...
    public Student getByUserId(Long userId) {
        log.info("Enter into getByUserId method of StudentServiceImpl with UserId {}", userId);
    ...
    public void ifGroupExist(Long id) {
        log.info("Enter into ifGroupExist method of StudentServiceImpl with GroupId {}", id);
