...
//    @Operation(summary = "Save archive schedule by semesterId in mongo db")
...
//
//        List<ScheduleWithoutSemesterDTO> schedules = scheduleService.getSchedulesBySemester(semesterId);
...
//        ScheduleFullForArchiveDTO scheduleForArchiveDTO = new ScheduleFullForArchiveDTO(
//                true,
//                scheduleFullDTO.getSemester(),
//                scheduleFullDTO.getSchedule()
//        );
//
//        scheduleService.deleteSchedulesBySemesterId(semesterId);
//        lessonService.deleteBySemesterId(semesterId);
...
//    @Operation(summary = "Get archive schedule by semesterId from mongo db")
//    @PreAuthorize("hasRole('MANAGER')")
...
//    @Operation(summary = "Get all semesters from archived schedules, that contains it")
//    @PreAuthorize("hasRole('MANAGER')")
...
//    @Operation(summary = "Delete archive schedule by semesterId from mongo db")
//    @PreAuthorize("hasRole('MANAGER')")
