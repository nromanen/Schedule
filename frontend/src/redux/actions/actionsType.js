...
export const GET_TEMPORARY_SCHEDULES = 'GET_TEMPORARY_SCHEDULES';
export const DELETE_TEMPORARY_SCHEDULE = 'DELETE_TEMPORARY_SCHEDULE';
export const SELECT_TEMPORARY_SCHEDULE = 'SELECT_TEMPORARY_SCHEDULE';
export const UPDATE_TEMPORARY_SCHEDULE = 'UPDATE_TEMPORARY_SCHEDULE';
export const ADD_TEMPORARY_SCHEDULE = 'ADD_TEMPORARY_SCHEDULE';
