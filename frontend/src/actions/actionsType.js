...
export const ASYNC_TOGGLE_DISABLED_GROUP = 'ASYNC_TOGGLE_DISABLED_GROUP';
...
export const ASYNC_CREATE_GROUP = 'ASYNC_CREATE_GROUP';
export const ASYNC_UPDATE_GROUP = 'ASYNC_UPDATE_GROUP';
export const ASYNC_CLEAR_GROUP = 'ASYNC_CLEAR_GROUP';
