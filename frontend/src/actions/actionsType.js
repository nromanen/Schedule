...
export const FETCH_DISABLED_GROUPS = 'FETCH_DISABLED_GROUPS';
export const FETCH_ENABLED_GROUPS = 'FETCH_ENABLED_GROUPS';
...
export const START_CLEAR_GROUP = 'START_CLEAR_GROUP';
