                    ...
                    {teacherLength > 0 ? (
                        visibleItems.map((teacher, index) => (
                            <Card key={index} {...teacher} class="teacher-card done-card">
                                ...
                                <p className="teacher-subtitle">{t('teacher_card_fullName')}</p>
                                ...
                                <p className="teacher-subtitle">{t('teacher_card_position')}</p>
                                <p className="teacher-card-title">{teacher.position}</p>
